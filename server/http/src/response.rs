...
use graph::prelude::{GraphQLError, QueryResult};
...
{
    result: Result<QueryResult<E>, GraphQLServerError<E>>,
}
...
impl<E> Serialize for GraphQLResponse<E>
where
    E: GraphQLError + Send + Sync + 'static,
{
        ...
        S: Serializer,
    {
        match self.result {
            Ok(ref result) => {
                ...
                map.serialize_entry("data", &SerializableValue(&result.data))?;
...
impl<E> Future for GraphQLResponse<E>
where
    E: GraphQLError + Send + Sync + 'static,
{
